...
- **Examples**: See `examples/` (halo nuclei, **16O(p,d)** `example_16Opd.clj`, **16O(d,p)** `example_16Odp.clj` — uses **`dwba.benchmark.o16-dp-handbook`** (handbook ZR + Austern (5.6), like **`ca40-pd-handbook`**), 11Li elastic/inelastic, etc.).
