...
\begin{equation}
  ...
  \exp\!\left[i\!\left(-\eta\ln\sin^2(\theta/2) + 2\sigma_0\right) + i\pi\right],
  \label{eq:fc}
\end{equation}
and the nuclear partial-wave amplitude is
\begin{equation}
  f_N(\theta) = -\frac{i}{k}\sum_{L=0}^{L_\mathrm{max}}
...
\begin{equation}
  ...
  \exp\!\left[-i\eta\ln\sin^2(\theta/2) + i\pi\right],
\end{equation}
\begin{equation}
  \tilde{f}_N(\theta) = -\frac{i}{k}\sum_{L=0}^{L_\mathrm{max}}
